    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-around p-8 overflow-y-auto h-full">
            <h3 className="text-center mb-4 font-bold text-2xl text-black">{project.name}</h3>
          <div className="flex flex-col gap-4 sm:w-3/4 text-black text-sm md:text-base">
          ...
          <div className="flex flex-col items-center justify-center ">
            <h4 className="text-center font-bold text-black">Technos utilisées:</h4>
            <p className="text-center mb-6 text-black">{project.technos}</p>
            {project.link && (
