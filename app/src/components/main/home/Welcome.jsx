...
export default function Welcome() {
  return (
    <section className="flex flex-col items-center  2xl:py-10 text-newBlack">
      <div className="flex p-8 mt-28 lg:mt-32 flex-col w-full lg:w-5/6 2xl:w-4/6  md:mb-10 lg:flex-row-reverse lg:mb-14">
        <div className="flex w-60 h-60  bg-cover    justify-center mb-8 m-auto md:mb-12 md:w-80 md:h-80 2xl:w-96 2xl:h-96 ">
          <DotLottieReact
            src="/animation/animationWork-file.lottie"
            // src="/animation/animation-Work-2.lottie"
            loop
            autoplay
          />
        </div>
